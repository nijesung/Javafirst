...
// 맵은 크래스 처럼 여러 종류의 데이터를 하나로 묶고자 할 때 사용한다.
// 클래스를 사용하는 것 보다 좋은 점은 저장하는 데이터의 이름을 변경할 때 편리하다.
// 클래스에 비해 안 좋은 점은 이름을 직접 문자열로 설정하기 때문에 코드 센스를 사용할 수 없다는 것이다.
// 이름을 사용하지 않고 모든 데이터 출력이 가능하다.
